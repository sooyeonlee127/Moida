...
import "../../utils/math/SafeMath.sol"; // 추가
...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    // Mapping owner address to token count (특정 주소 별 토큰 보유 수)
     ...
     * 토큰의 이름과 심볼을 매개변수로 받아 상태 변수에 저장한다.
     */
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        // 같은 토큰 이름과 심볼피 표시되면 혼동을 줄 수 있으므로 고유한 이름과 심볼을 사용하도록 권장
    }
