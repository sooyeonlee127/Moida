    ...
    return (
            ...
            <form action="#" method="POST" className="mx-auto mt-8 max-w-xl sm:mt-8">
                ...
                <div className="sm:col-span-2">
                    ...
                    <input type="email" name="email" id="email" autocomplete="email" required className="block w-full rounded-md border-0 py-2 px-3.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"/>
                    </div>
                </div>
                <div className="sm:col-span-2">
                    <label htmlfor="nickname" className="block text-sm leading-6 text-gray-900">Nickname</label>
                    <div className="mt-2.5">
                    <input type="text" name="nickname" id="nickname" required className="block w-full rounded-md border-0 py-2 px-3.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"/>
                    </div>
                </div>
                <div className="sm:col-span-2">
                    <label htmlfor="phone-number" className="block text-sm leading-6 text-gray-900">Phone number</label>
                    <div className="flex flex-row space-x-4">
                        <select id="phone" name="phone" required className="h-full rounded-md ring-1 ring-inset ring-gray-300 border-0 py-1.5 pl-4 pr-9">
                            <option>010</option>
                        </select>
                         -
                        <input type="text" name="phone" required className="rounded-md ring-1 ring-inset ring-gray-300 relative rounded-t-md border-0 py-1.5 "/> -
                        <input type="text" name="phone" required className="rounded-md ring-1 ring-inset ring-gray-300 relative rounded-t-md border-0 py-1.5 "/>
                    </div>
                </div>
                <div className="sm:col-span-2">
