...
const NftPage = () => {
  ...
  async function fetchRandomImage() {
    try {
      ...
      const imageUrl = 'https://s3.ap-northeast-2.amazonaws.com/moida.bucket/static/article/e17365b6-2fd9-4f77-8fe5-2e3a79a7ef9b';
  ...
  <div>
    ...
    <div className="Meta">
      ...
      <div>
        {img ? <img src={img} alt="Random Image" /> : <p>Loading...</p>}
      </div>
    </div>
    {/* <div>
